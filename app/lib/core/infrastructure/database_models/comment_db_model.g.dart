...
const CommentDbModelSchema = CollectionSchema(
  ...
  links: {
    r'post': LinkSchema(
      id: 829030554419611882,
      name: r'post',
      target: r'PostDbModel',
      single: true,
    ),
    r'user': LinkSchema(
      id: 5461416692197171950,
      name: r'user',
...
extension CommentDbModelQueryLinks
    on QueryBuilder<CommentDbModel, CommentDbModel, QFilterCondition> {
  QueryBuilder<CommentDbModel, CommentDbModel, QAfterFilterCondition> post(
  ...
  QueryBuilder<CommentDbModel, CommentDbModel, QAfterFilterCondition> user(
...
extension CommentDbModelQuerySortBy
  ...
  QueryBuilder<CommentDbModel, CommentDbModel, QAfterSortBy> sortByContent() {
    return QueryBuilder.apply(this, (query) {
...
extension CommentDbModelQuerySortThenBy
  ...
  QueryBuilder<CommentDbModel, CommentDbModel, QAfterSortBy> thenByContent() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'content', Sort.asc);
    });
  }
...
extension CommentDbModelQueryWhereDistinct
  ...
  QueryBuilder<CommentDbModel, CommentDbModel, QDistinct> distinctByContent(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CommentDbModelQueryProperty
  ...
  QueryBuilder<CommentDbModel, String, QQueryOperations> contentProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'content');
    });
  }

  QueryBuilder<CommentDbModel, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
